...
function App() {
	...
	return (
		<div className="container mx-auto px-20 my-10">
			<h1 className="mt-10 scroll-m-20 border-b border-b-slate-200 pb-2 text-3xl font-semibold tracking-tight transition-colors first:mt-0 dark:border-b-slate-700">
				Panager
			</h1>
